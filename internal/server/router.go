...
func MakeRouter(db *gorm.DB, appConfig *config.Config, fcmClient *fcm.FCMClient, redisClient *redis.Client) *gin.Engine { //nolint:funlen
	...
	protected.Use(middleware.AuthMiddleware())
	{
		...
		protected.POST("/api/user/block", userHandler.BlockUser)
		protected.DELETE("/api/user/block/:id", userHandler.UnblockUser)
		protected.GET("/api/user/blocked", userHandler.GetBlockedUsers)
